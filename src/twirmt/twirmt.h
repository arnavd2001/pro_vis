...
/*
 * $Id: twirmt.h,v 1.24 2012-12-31 22:22:03-08 geoff Exp $
 *
 ...
 * inlined or being compiled directly (in twirmt.c).  Get rid of a #ifdef
 ...
 * For compilers that don't have the inline feature, twirmt.c will
...
/*
 * Make it possible for twirmt.c to disable the inline keyword.  We
